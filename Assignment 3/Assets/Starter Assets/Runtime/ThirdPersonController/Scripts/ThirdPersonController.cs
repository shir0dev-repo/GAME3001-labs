...
namespace StarterAssets
{
    ...
    public class ThirdPersonController : MonoBehaviour
    {
        ...
        [Header("Animator")]
        [Tooltip("How long until the player's idle animation plays")]
        ...
        private void Start()
        {
            ...
            _idleAnimHash = Animator.StringToHash("Base Layer.player_look_around");
        }
        ...
        private void Move()
        {
            ...
            _animator.SetFloat("_velocity", _animationBlend);
        ...
        private void CheckForIdleAnimation()
        {
            if (_speed > 0)
                _idleTimer = 0;
            else if (_idleTimer >= IdleThreshold)
            {
                _idleTimer = 0;
                _animator.SetTrigger("_idleThreshold");
            }
            else if (_animator.GetCurrentAnimatorStateInfo(0).fullPathHash != _idleAnimHash)
            {
